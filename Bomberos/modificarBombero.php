...
<body background="images/fondofichaintranet.jpg">
	...
	<br>
	<nav class="navbar navbar-default nav-stacked  navbar-pills"
		role="navigation">
		...
		<div class="collapse navbar-collapse navbar-ex1-collapse">
			<ul class="nav navbar-nav">
				<li class="dropdown"><a href="#" class="dropdown-toggle"
					data-toggle="dropdown">Bomberos <b class="caret"></b></a>
			...
			<ul class="nav navbar-nav">
				<li class="dropdown"><a href="#" class="dropdown-toggle"
					data-toggle="dropdown">Unidades <b class="caret"></b></a>
					<ul class="dropdown-menu">
			...
			<ul class="nav navbar-nav">
				<li class="dropdown"><a href="#" class="dropdown-toggle"
					data-toggle="dropdown">Inventario <b class="caret"></b></a>
					<ul class="dropdown-menu">
			...
			<ul class="nav navbar-nav">
				<li class="dropdown"><a href="#" class="dropdown-toggle"
					data-toggle="dropdown">Despacho <b class="caret"></b></a>
					<ul class="dropdown-menu">
			...
			<ul class="nav navbar-nav">
				<li class="dropdown"><a href="#" class="dropdown-toggle"
					data-toggle="dropdown">Reporte <b class="caret"></b></a>
					<ul class="dropdown-menu">
			...
			<button class="btn btn-default" style="width: 150px;"
				...
				<a href="crearUsuario.php"
					style="text-decoration: none; color: black;">Crear Usuario</a>
			</button>
			...
			<button class="btn btn-danger" style="width: 150px;"
				...
				<a href="controlador/CerrarSesion.php"
					style="text-decoration: none; color: black;">Cerrar Sesion</a>
			</button>
	...
	<div class="cuerpo"
		style="margin-left: 20%; float: left; width: 75%; padding-left: 5%; padding-top: -100%; margin-top: -950px; margin-bottom: -1000px;">
		...
		<div style="width: 1050px" style="height: 900px">
			<div class="jumbotron" style="border-radius: 70px 70px 70px 70px"
				...
				<div class="container" style="margin-left: -0px;">
						...
						<div class="panel panel-default">
							...
							<div id="collapseOne" class="panel-collapse collapse in"
								...
								<div class="panel panel-primary">
									<div class="panel-heading panel-title">Información Personal</div>
									<div class="panel-body">
										<div class="col-sm-5">
											...
											<form id="formactualizarPersonal"
												action="controlador/ActualizarInfoPersonal.php"
												method="post">
												Talla Chaqueta/camisa : <input class="form-control"
													value="<?php echo $infoMedidas->getTallaChaquetaCamisa();?>"
													type="text" name="txtchaqueta"> Talla Pantalón: <input
													class="form-control"
													value="<?php echo $infoMedidas->getTallaPantalon();?>"
													type="text" name="txtpantalon"> Talla buzo: <input
													class="form-control"
													value="<?php echo $infoMedidas->getTallaBuzo();?>"
													type="text" name="txtbuzo"> Talla Calzado: <input
													class="form-control"
													value="<?php echo $infoMedidas->getTallaCalzado();?>"
													type="text" name="txtcalzado"> Altura :<input
													class="form-control"
													value="<?php echo $infoPersonal->getAlturaEnMetros();?>"
													type="text" name="txtaltura"> Peso: <input
													class="form-control"
													value="<?php echo $infoPersonal->getPeso();?>" type="text"
													name="txtpeso"> Perteneció a Brigada Juvenil? <input
													class="form-control"
													value="<?php echo $infoPersonal->getPertenecioABrigadaJuvenil();?>"
													type="text" name="txtbrigada"> Instructor: <input
													class="form-control"
													value="<?php echo $infoPersonal->getEsInstructor();?>"
													type="text" name="txtinstructor">
										
										</div>

										<div class="col-md-5" style="margin-left: 50px;">
											<input class="form-control"
												value="<?php echo $infoPersonal->getIdInfoPersonal();?>"
												type="hidden" name="idPersonal"> <br> <br> Rut: <input
												class="form-control"
												value="<?php echo $infoPersonal->getRutInformacionPersonal();?>"
												type="text" name="txtRut"
												onblur="this.value = this.value.replace( /^(\d{2})(\d{3})(\d{3})(\w{1})$/, '$1.$2.$3-$4')">
											Nombre: <input class="form-control"
												value="<?php echo utf8_encode($infoPersonal->getNombreInformacionPersonal());?>"
												type="text" name="txtNombre"> Apellido Paterno: <input
												class="form-control"
												value="<?php echo utf8_encode($infoPersonal->getApellidoPaterno());?>"
												type="text" name="txtApePa"> Apellido Materno: <input
												class="form-control"
												value="<?php echo utf8_encode($infoPersonal->getApellidoMaterno());?>"
												name="txtApeMa"> Fecha Nacimiento: <input
												class="form-control"
												value="<?php echo $infoPersonal->getFechaNacimiento();?>"
												name="txtFecha" type="date"> Estado Civil: <select
												class="form-control" name="cboEstadoCivil">
                     <?php
                    ...
                    ?>
                     </select> Dirección: <input class="form-control"
												value="<?php echo $infoPersonal->getDireccionPersonal();?>"
												Type="text" name="txtDireccion"> Teléfonos: <input
												class="form-control"
												value="<?php echo $infoPersonal->getTelefonoFijo();?>"
												type="text" name="txtTelefonos"> Email: <input
												class="form-control"
												value="<?php echo $infoPersonal->getEmail();?>" type="text"
												name="txtemail"> Genero: <select class="form-control"
												name="cboGenero">
                       <?php
                    require_once ("model/Data.php");
                    ...
                    ?>
                        ...
                        ?>
											...
											<center>
												<input type="submit" id="btn_actualizarInfoPersonal"
													name="btnInfoPersonal" value="Modificar"
													class="btn button-primary" style="width: 150px;"> <span></span>
						...
						<div class="panel panel-default">
							<div class="panel-heading" role="tab" id="headingTwo">
								<h4 class="panel-title">
									<a class="collapsed" style="text-decoration: none;"
							...
							<div id="collapseTwo" class="panel-collapse collapse"
								...
								<div class="panel panel-primary">
									<div class="panel-heading panel-title">Información Bomberil</div>
									<div class="panel-body">
										<div class="col-sm-6">

											<form id="formactualizarBomberil"
												action="controlador/actualizarInformacionBomberil.php"
												method="post">
												<input class="form-control"
													value="<?php echo $infoPersonal->getIdInfoPersonal();?>"
													type="hidden" name="idPersonal"> <input
													class="form-control"
													value="<?php echo $infoBomberil->getIdInformacionBomberil();?>"
													type="hidden" name="idBomberil"> Región :
												<!-- <input class="form-control" type="text" name="txtregion"> -->
												<!--Region del libertador bernardo ohggins-->
                    ...
                    foreach ($companias as $c => $compania) {
                        if ($infoBomberil->getfkCompaniainformacionBomberil() == $compania->getIdEntidadACargo()) {
                            ?>
                             <option
														value="<?php echo $compania->getIdEntidadACargo(); ?>"
														selected><?php echo utf8_encode($compania->getNombreEntidadACargo()); ?></option>
                             <?php
                        } else {
                            ?>
                               <option
                    ...
                    ?>
                        ...
                        ?>
                         </select> Fecha Ingreso: <input
													class="form-control"
													value="<?php echo $infoBomberil->getfechaIngresoinformacionBomberil();?>"
													type="date" name="txtfingreso"> Nº Reg.General: <input
													class="form-control"
													value="<?php echo $infoBomberil->getNRegGeneralinformacionBomberil();?>"
													type="number" name="txtgeneral">
										
										</div>
										<div class="col-md-6">
											Cuerpo: <input class="form-control"
												value="<?php echo $infoBomberil->getcuerpoInformacionBomberil();?>"
												type="text" name="txtcuerpo"> Cargo:
											<!-- <input class="form-control" type="text" name="txtcargo"> -->
                    ...
                    foreach ($cargos as $c => $cargo) {
                        if ($infoBomberil->getfkCargoinformacionBomberil() == $cargo->getIdCargo()) {
                            ?>
                           <option
													value="<?php echo $cargo->getIdCargo(); ?>" selected><?php echo utf8_encode($cargo->getNombreCargo()); ?></option>
                           <?php
                        } else {
                            ?>
                             <option
													value="<?php echo $cargo->getIdCargo(); ?>"><?php echo utf8_encode($cargo->getNombreCargo()); ?></option>
                             <?php
                        }
                    }
                    ?>
                    ...
                    ?>
                        ...
                        ?>
                       </select> Nº Reg.Cia: <input
												class="form-control" type="number"
												value="<?php echo $infoBomberil->getNRegCiainformacionBomberil();?>"
												name="txtcia"> <br>
											<center>
												<input type="submit" id="btn_actualizarBomberil"
													name="btnInfoBomberil" value="Modificar"
													class="btn button-primary" style="width: 150px;"> <span></span>
												<!--     <button class="btn button-primary" style="width: 150px;"> <a href="Mantenedor.php" style="text-decoration:none;color:black;">Volver</a> </button>-->
						...
						<div class="panel panel-default">
							...
							<div id="collapseThree" class="panel-collapse collapse"
								...
								<div class="panel panel-primary">
									<div class="panel-heading panel-title">Información Laboral</div>
									<div class="panel-body">
										<div class="col-sm-5">

											<form id="formactualizarInfoLaboral"
												action="controlador/ActualizarInformacionLaboral.php"
												method="post">
												<input class="form-control"
													value="<?php echo $infoPersonal->getIdInfoPersonal();?>"
													type="hidden" name="idPersonal"> <input
													class="form-control"
													value="<?php echo $infoLaboral->getIdidInformacionLaboral();?>"
													type="hidden" name="idLaboral"> Nombre Empresa : <input
													class="form-control"
													value="<?php echo $infoLaboral->getnombreEmpresainformacionLaboral();?>"
													type="text" name="txtnomempresa"> Dirección Empresa: <input
													class="form-control"
													value="<?php echo $infoLaboral->getdireccionEmpresainformacionLaboral();?>"
													type="text" name="txtdirecempresa"> Teléfono Empresa: <input
													class="form-control"
													value="<?php echo $infoLaboral->gettelefonoEmpresainformacionLaboral();?>"
													type="text" name="txttlfempresa"> Fecha Ingreso: <input
													class="form-control"
													value="<?php echo $infoLaboral->getfechaIngresoEmpresainformacionLaboral();?>"
													type="date" name="txfingresoempresa">
										
										</div>
										<div class="col-md-5">
											cargo : <input class="form-control"
												value="<?php echo $infoLaboral->getcargoEmpresainformacionLaboral();?>"
												type="text" name="txtcargo"> Area/Depto de trabajo: <input
												class="form-control"
												value="<?php echo $infoLaboral->getareaDeptoEmpresainformacionLaboral();?>"
												type="text" name="txtareatrabajo"> AFP: <input
												class="form-control"
												value="<?php echo $infoLaboral->getafp_informacionLaboral();?>"
												type="text" name="txtafp"> Profesión: <input
												class="form-control"
												value="<?php echo $infoLaboral->getprofesion_informacionLaboral();?>"
												name="txtprofesion"> <br>
											<center>
												<input type="submit" id="btn_actualizarInfoLaboral"
													name="btnInfoLaboral" value="Modificar"
													class="btn button-primary" style="width: 150px;"> <span></span>
												<!--     <button class="btn button-primary" style="width: 150px;"> <a href="Mantenedor.php" style="text-decoration:none;color:black;">Volver</a> </button>-->
						...
						<div class="panel panel-default">
							...
							<div id="collapsefour" class="panel-collapse collapse"
								...
								<div class="panel panel-primary">
									<div class="panel-heading panel-title">Información Medica</div>
									<div class="panel-body">

										<div class="col-sm-6">

											<form id="formactualizarInfoMedica"
												action="controlador/CrearInformacionMedica.php"
												method="post">
												...
												<input class="form-control"
													...
													type="hidden" name="idPersonal"> <input
													class="form-control"
													value="<?php echo $infoMedica1->getidInformacionMedica1();?>"
													type="hidden" name="idMedico1"> <input class="form-control"
													value="<?php echo $infoMedica2->getidInformacionMedica2();?>"
													type="hidden" name="idMedico2"> Prestación Médica : <input
													class="form-control"
													value="<?php echo $infoMedica1->getprestacionMedica_informacionMedica1();?>"
													type="text" name="txtpresmedica"> Alergias: <input
													class="form-control"
													value="<?php echo $infoMedica1->getalergias_informacionMedica1();?>"
													type="text" name="txtalergias"> Enfermedades Crónicas: <input
													class="form-control"
													value="<?php echo $infoMedica1->getenfermedadesCronicasinformacionMedica1();?>"
													type="text" name="txtenfermedadescronicas"> Medicamentos
												Habituales: <input class="form-control"
													value="<?php echo $infoMedica2->getmedicamentosHabitualesinformacionMedica2();?>"
													type="text" name="txtmedicamentosHabituales"> Nombre del
												Contacto: <input class="form-control"
													value="<?php echo $infoMedica2->getnombreContactoinformacionMedica2();?>"
													type="text" name="txtnomContacto"> Teléfono del Contacto :
												<input class="form-control"
													value="<?php echo $infoMedica2->gettelefonoContactoinformacionMedica2();?>"
													type="text" name="txttlfcontacto">
										
										</div>
										<div class="col-md-6">

											Parentesco del Contacto:
											<!-- <input class="form-control" type="text" name="txtparentesco"> -->
                    ...
                    foreach ($parentescos as $p => $parentesco) {
                        if ($infoMedica2->getfkParentescoContactoinformacionMedica2() == $parentesco->getIdParentesco()) {
                            ?>
                           <option
													value="<?php echo $parentesco->getIdParentesco(); ?>"
													selected><?php echo utf8_encode($parentesco->getNombreParentesco()); ?></option>
                           <?php
                        } else {
                            ?>
                             <option
                    ...
                    ?>
                       </select> Nivel de actividiad física: <input
												class="form-control"
												value="<?php echo $infoMedica2->getnivelActividadFisicainformacionMedica2();?>"
												type="text" name="txtactvfisica"> <br>
                     <?php
                    ...
                    ?>
                     ...
                     Donante:  <input class="form-control"
												value="seleccionado" type="checkbox"
												<?php echo $donanteChequeado;?> name="txtdonante"> Fumador:
											<input class="form-control" value="seleccionado"
												type="checkbox" <?php echo $fumadorChequeado;?>
												name="txtfumador"> Grupo Sanguineo:
											<!-- <input class="form-control" type="text" name="txtgruposanguineo"> -->
                    ...
                    foreach ($grupos as $g => $grupo) {
                        ...
                        if ($infoMedica2->getfkGrupoSanguineoinformacionMedica2() == $grupo->getIdGrupoSanguineo()) {
                            ?>
                           <option
													value="<?php echo $grupo->getIdGrupoSanguineo(); ?>"
													selected><?php echo $grupo->getNombreGrupoSanguineo(); ?></option>
                           <?php
                        } else {
                            ?>
                             <option
                    ...
                    ?>
                        ...
                        ?>
											...
											<center>
												<input type="submit" id="btn_actualizarInfoMedica"
													name="btninfoMedica" value="Modificar"
													class="btn button-primary" style="width: 150px;"> <span></span>
												<!--     <button class="btn button-primary" style="width: 150px;"> <a href="Mantenedor.php" style="text-decoration:none;color:black;">Volver</a> </button>-->
						...
						<div class="panel panel-default">
							...
							<div id="collapsefive" class="panel-collapse collapse"
								...
								<div class="panel panel-primary">
									<div class="panel-heading panel-title">Información Familiar</div>
									<div class="panel-body">


										<div class="col-sm-6">
											<form id="formCrearInfoFamiliarEnModificar"
												action="controlador/CrearInformacionFamiliar.php"
												method="post">
												Nombre: <input class="form-control" type="text"
													id="nomFamiliar" name="txtnombreFamiliar"> Fecha de
												Nacimiento: <input class="form-control" type="date"
													id="fecNFamiliar" name="txtfechafamiliar"> Parentesco: <select
													class="form-control" name="cboParentesco2"
													id="cboParentescoFamiliar">
                       <?php
                    require_once ("model/Data.php");
                    require_once ("model/Tbl_Parentesco.php");
                    $d = new Data();
                 ...
                 <button class="btn button-primary" style="width: 150px;"> <a href="Mantenedor.php" style="text-decoration:none;color:black;">Volver</a> </button>
                        ...
                        ?>
										...
										<div class="col-md-6">
											...
											<br> <br> <br> <br> <br> <br> <input type="submit"
												id="btn_crearInfoFamiliarEnModificar" name="btninfoFamiliar"
												value="Agregar" class="btn button-primary"
												style="width: 150px;"> <span></span> <input
												class="form-control" value="" type="hidden"
												id="idPersonalFamiliar" name="idPersonalFamiliar">
											<!--     <button class="btn button-primary" style="width: 150px;"> <a href="Mantenedor.php" style="text-decoration:none;color:black;">Volver</a> </button>-->
										</div>
						...
						<div class="panel panel-default">
							...
							<div id="collapsesix" class="panel-collapse collapse"
								...
								<div class="panel panel-primary">
									<div class="panel-heading panel-title">Información Academica</div>
									<div class="panel-body">
										<div class="col-sm-6">
											<form id="formCrearInfoAcademicaEnModificar"
												action="controlador/CrearInformacionAcademica.php"
												method="post">
												Fecha: <input class="form-control" type="date"
													name="txtfechaAcademica"> Actividad: <input
													class="form-control" type="text"
													name="txtActivdidadAcademica"> Estado: <select
													class="form-control" name="cboEstadoCursoAcademico">
                           <?php
                        require_once ("model/Data.php");
                        ...
                        foreach ($estadosDeCursos as $ec => $estado) {
                            ?>
                           <option
														value="<?php echo $estado->getIdEstadoCurso(); ?>"><?php echo $estado->getNombreEstadoCurso(); ?></option>
                           <?php
                        }
                        ?>
                           </select>
                            ...
                            ?>
										...
										<div class="col-md-6">
											<br> <br> <br> <br> <br> <input type="submit"
												id="btn_crearInfoAcademicaEnModificar"
												name="btninfoAcademica" value="Agregar"
												class="btn button-primary" style="width: 150px;"> <span></span>
											<input class="form-control" value="" type="hidden"
												id="idPersonalAcadem" name="idPersonalAcadem"> <br>
						...
						<div class="panel panel-default">
							...
							<div id="collapseseven" class="panel-collapse collapse"
								...
								<div class="panel panel-primary">
									<div class="panel-heading panel-title">Información
										Entrenamiento Estandar</div>
									<div class="panel-body">


										<div class="col-sm-6">
											<form id="formCrearInfoEntrenamientoEstandarEnModificar"
												action="controlador/CrearInfoEntrenamientoEstandar.php"
												method="post">
												Fecha: <input class="form-control" type="date"
													name="txtfechaEstandar"> Actividad: <input
													class="form-control" type="text"
													name="txtActividadEntrenamientoEstandar"> Estado: <select
													class="form-control" name="cboEstadoCursoEstandar">
                             <?php
                            require_once ("model/Data.php");
                            require_once ("model/Tbl_EstadoCurso.php");
                            $d = new Data();
                            ...
                            foreach ($estadosDeCursos2 as $ec2 => $estado2) {
                                ?>
                             <option
														value="<?php echo $estado2->getIdEstadoCurso(); ?>"><?php echo utf8_encode($estado2->getNombreEstadoCurso()); ?></option>
                             <?php
                            }
                            ?>
                             </select> <br>
                              ...
                              <?php
                                ...
                                ?>
										...
										<div class="col-md-6">
											<br> <br> <br> <br> <br> <input type="submit"
												id="btn_crearInfoEntrenEstandarEnModificar"
												name="btninfoEstandar" value="Crear"
												class="btn button-primary" style="width: 150px;"> <span></span>
						...
						<div class="panel panel-default">
							<div class="panel-heading" role="tab" id="headingocho">
								<h4 class="panel-title">
									<a class="collapsed" style="text-decoration: none;"
										role="button" data-toggle="collapse" data-parent="#accordion"
										href="#collapseocho" aria-expanded="false"
										aria-controls="collapseocho">
										<center>Información Histórica</center>
									</a>
								</h4>
							</div>
							<div id="collapseocho" class="panel-collapse collapse"
								role="tabpanel" aria-labelledby="headingocho">
								<div class="panel panel-primary">
									<div class="panel-heading panel-title">Información Histórica
									</div>
									<div class="panel-body">

										<div class="col-sm-6">
											<form id="formCrearInfoHistoricaEnModificar"
												action="controlador/CrearInformacionHistorica.php"
												method="post">

												Región: <select class="form-control" name="cboxRegion">
                             <?php
                            require_once ("model/Data.php");
                            require_once ("model/Tbl_Region.php");
                            $d = new Data();
                            ...
                            ?>
                             </select> Cuerpo: <input type="text"
													name="txtcuerpoHistorico" class="form-control"> Compañia:<input
													type="text" name="txtCompania" class="form-control"> Fecha:
												<input type="date" name="txtfechaCambioInfoHistorica"
													class="form-control">
										...
										<div class="col-md-6">
											...
											Premio: <input type="text" name="txtPremioInforHistorica"
												class="form-control"> Cargo: <input type="text"
												name="cboxCargo" class="form-control"> Motivo: <input
												type="text" name="txtMotivo" class="form-control"> Detalle:
											<input type="text" name="txtDetalleHistorico"
												class="form-control"> <br> <br>
										</div>

										<center>
											<input type="submit" id="btn_crearInfoHistoricaEnModificar"
												name="btninfohistorica" value="Crear"
												class="btn button-primary" style="width: 150px;"> <span></span>
						...
						<div class="panel panel-default">
							...
							<div id="collapsenine" class="panel-collapse collapse"
								role="tabpanel" aria-labelledby="headingnueve">
								<div class="panel panel-primary">
									<div class="panel-heading panel-title">
										<form id="formCrearInfoCargos"
											action="controlador/CrearInformacionDeCargos.php"
											method="post">Información de Cargos
									...
									<div class="col-sm-6">
                                        ...
                                        ?>
                                         <br> Entidad a Cargo: <select
											name="cboEntidadACargo" id="cboEntidadACargo"
											class="form-control" onchange="actualizarComboBox()">
                                              <?php
                                            ...
                                            ?>
                                          </select> Material menor a
										asignar:
										<div class="ui-widget" class="form-control"
											style="width: 100px;">
											<select name="cboMaterialesDisponibles"
												id="cboMaterialesDisponibles" class="form-control"
												onchange="actualizarStockDisponible(), cargarDatosDeMaterialSeleccionado()">
                                            <?php
										...
										<center>
											<input type="submit" name="btnInfoCargos" id="btn_crearCargo"
												value="Guardar" class="btn button-primary"
												style="width: 150px;"> <span></span>
										</center>
										<br>
										<div>
											Marca:<br> <input type="text" id="detalleMarca"
												name="detalleMarca" disabled style="width: 260px;"> <br>
											Color:<br> <input type="text" id="detalleColor"
												name="detalleColor" disabled style="width: 260px;"> <br>
											Proveedor:<br> <input type="text" id="detalleProveedor"
												name="detalleProveedor" disabled style="width: 260px;"> <br>
											Estado: <br> <input type="text" id="detalleEstado"
												name="detalleEstado" disabled style="width: 256px;"> <br>
										</div>
										...
										<div class="container">
											<div class="row">
												<div class="col-md-auto">
													<br> Ubicacion Fisica: <select name="cboxUbicacion"
														id="cboxUbicacion" class="form-control"
														onchange="actualizarComboBoxDeMateriales()">
                               <?php
                            ...
                            ?>
													...
													<div class="col-md-auto">
														Stock: <input type="number" class="form-control"
															id="stock" name="stock" style="width: 50px;" disabled>
													</div>

													<div class="col-md-auto"
														style="margin-left: 80px; margin-top: -55px;">
														Cantidad a asignar: <input type="number"
															class="form-control" style="width: 50px;" value="1"
															id="cantidadDeMaterialesAsignados"
									...
									<div style="margin-top: 120px;">
										<br> <br> <br> <br> Fecha de caducidad: <br> <input
											type="text" id="detalleFecha" name="detalleFecha" disabled
											style="width: 170px;"> <br> Medida: <br> <input type="text"
											id="detalleMedida" name="detalleMedida" disabled
											style="width: 250px;"> <br> Tipo de medida: <br> <input
											type="text" id="detalleTipoDeMedida"
											name="detalleTipoDeMedida" disabled style="width: 200px;"> <br>
										Observaciones: <br> <input type="text"
											id="detalleObservaciones" name="detalleObservaciones"
											disabled style="width: 200px;"> <br>
									</div>
