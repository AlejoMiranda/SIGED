...
$ordenConsultaUno = 1; // usamos esta varibale para saber si agregar el where o no A LA COMPA�IA;
$ordenConsultaDos = 1; // usamos esta varibale para saber si agregar el where o no A LA COMPA�IA Y ESTADO;
$ordenConsultaTres = 1; // usamos esta varibale para saber si agregar el where o no A LA COMPA�IA, ESTADO Y BODEGA;
...
if ($_POST['chkComDos']) {
    if($ordenConsultaUno == 1){
        $cadenaUno = $cadenaUno .= " compania LIKE '1� Compa��a'";
        $ordenConsultaUno = 2;
    }else{
        $cadenaUno = $cadenaUno .= " OR compania LIKE '1� Compa��a'";
    }
}

if ($_POST['chkComTres']) {
    if($ordenConsultaUno == 1){
        $cadenaUno = $cadenaUno .= " compania LIKE '2� Compa��a'";
        $ordenConsultaUno = 2;
    }else{
        $cadenaUno = $cadenaUno .= " OR compania LIKE '2� Compa��a'";
    }
}

if ($_POST['chkComCuatro']) {
    if($ordenConsultaUno == 1){
        $cadenaUno = $cadenaUno .= " compania LIKE '3� Compa��a'";
        $ordenConsultaUno = 2;
    }else{
        $cadenaUno = $cadenaUno .= " OR compania LIKE '3� Compa��a'";
    }
}
// compa�ias
//-----------------------------------------
...
if ($_POST['chkEsTres']) {
    if($ordenConsultaDos == 1){
        $cadenaDos = $cadenaDos .= " estado LIKE 'En Mantenci�n'";
        $ordenConsultaDos = 2;
    }else{
        $cadenaDos = $cadenaDos .= " OR estado LIKE 'En Mantenci�n'";
    }
}
