                    ...
                    <div class="panel-body">
                      <div class="col-sm-4">
                        ...
                        <form id="formCrearUnidad" action="controlador/CrearUnidades.php" method="post">
                          ...
                          PPU: <br><input class="form-control onlyNumber" id="nombre" type="text" name="txtppu" class="form-control" required="">
                      ...
                      <div class="col-sm-6" style="margin-left: 60px;">
                        ...
                        Nombre Unidad:<input class="form-control onlyLetter" id="nombreDeLaUnidadACrear" type="txt" class="form-control" name="txtnombreUnidad" required="">
