      ...
      <div class="jumbotron" style="border-radius: 70px 70px 70px 70px" id="transparencia">
        <div class="container">
          ...
          <div class="form-group" style="margin-left:50px;">
            <span>
              <h5 style="font-weight:bold;">Inventario</h5>
            </span>

            <form id="formCrearMaterialMenor" action="controlador/CrearMaterialMenor.php" method="post">

              Nombre Material: &nbsp;&nbsp;&nbsp;&nbsp;
              <input type="text" class="onlyLetter"  name="txtnombreMaterial onlyLetter" id="txtnombreMaterial" required style="width:575px;"><br><br>
              ...
              Marca: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              <input type="text" class="onlyLetter" name="txtmarca" required style="width:230px;">

              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              Color:
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              <input Type="text" class="onlyLetter" name="txtColor" required style="width:195px;"><br><br>

              Proveedor: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              <input type="text" class="onlyLetter" name="txtProveedor" required style="width:230px;">
              ...
              Cantidad:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              <input type="number" class="onlyNumber" name="txtcantidadMaterial" style="width:150px;">

              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              Medida: <input type="number" class="onlyNumber" name="numMedida" required style="width:100px;"> /
              ...
              <br>
              Detalle: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              <input type="text" class="onlyNumbLetter" name="txtDetalle" required style="width:575px;">
