...
$unidades = $data->mostrarUnidadesReporte();
...
$html='
        ...
        <div>
           <link rel ="stylesheet" href="../css/printStyle.css" type="text/css">
	           ...
	           <div>
        		   ...
        		   <h4  id="txt3Cabecera" >'.utf8_encode("Reporte Módulo Unidad - Listado de Unidades").'</h4>
  ...
  <th class="tableHead">' . utf8_encode("N° Chasis") . '</th>
  <th class="tableHead">Tipo Unidad</th>
  <th class="tableHead">Fecha de Registro</th>
  </tr>
  </thead>
  <tbody>';
...
foreach ($unidades as $u => $unidad) {
  ...
  <td class="td">' . utf8_encode($unidad->getChasis()) . '</td>
  <td class="td">' . utf8_encode($unidad->getTipoUnidad()) . '</td>
  <td class="td">' . utf8_encode($unidad->getFechaRegistro()) . '</td>';
}
...
$mpdf->SetTitle('Listado de Unidades');
