...
$unidades = $data->getUnidadesParaReporteByCompania($idCompania, $fechaDesde, $fechaHasta);
...
$html='
        ...
        <div>
           <link rel ="stylesheet" href="../css/printStyle.css" type="text/css">
	           ...
	           <div>
        		   ...
        		   <h4  id="txt3Cabecera" >'.utf8_encode("Reporte Módulo Unidad - Por Compañia").'</h4>
  ...
  <th class="tableHead">' . utf8_encode("Tipo Mantención") . '</th>
  <th class="tableHead">' . utf8_encode("Fecha Mantención") . '</th>
  <th class="tableHead">' . utf8_encode("Detalle Mantención") . '</th>
  </tr>
  </thead>
  <tbody>';
